...
const MainHeroPage = ({ darkMode, setDarkMode }) => {
  ...
  return (
    ...
    >
      {/* Navigation */}
      <nav
        className={`relative z-10 border-b transition-all duration-300 ${
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                >
                  Academic
                  <span className="block text-blue-600">Scheduling</span>
                ...
                >
                  The modern way to organize your academic life. Schedule
                  classes, track assignments, and never miss a deadline.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  className={`px-8 py-3 font-semibold rounded-lg border transition-colors duration-200 flex items-center justify-center space-x-2 ${
                    darkMode
                    ...
                    {[
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div
                            className={`w-3 h-3 rounded-full bg-${event.color}-500`}
                          />
                        </div>
                      </div>
                    ))}
