...
import AddToGoogleCalendarButton from "../../components/ui/AddToGoogleCalendarButton";
  ...
  useEffect(() => {
    ...
    if (location.state?.editEvent) {
      const eventToEdit = events.find(
        (ev) => (ev._id || ev.id) === location.state.editEvent
      );
      if (eventToEdit) {
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        {/* Timeline Container */}
        <div
          className={`relative backdrop-blur-xl rounded-3xl border shadow-2xl overflow-hidden ${
            darkMode
          ...
          <div className="p-8">
            {todayEvents.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20">
                <div
                  className={`w-20 h-20 rounded-full border-2 border-dashed flex items-center justify-center mb-6 ${
                    darkMode
                ...
                >
                  Your schedule is clear. Perfect time to plan your day or add
                  new events.
                </p>
              </div>
            ) : (
                                    ...
                                    <div className="flex-1 min-h-0">
                                      <div className="flex items-start justify-between mb-2">
                                        <div className="flex-1 min-w-0">
                                          ...
                                          {event.description && (
                                            <p
                                              className={`text-sm mt-1 opacity-75 line-clamp-2 ${
                                                getEventColors(event.category)
                                                  .text
                                              }`}
                                            >
        ...
        {selectedEvent && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm overflow-y-auto">
            <div
              className={`relative w-full max-w-lg max-h-[90vh] overflow-y-auto backdrop-blur-xl rounded-3xl border shadow-2xl ${
                darkMode
