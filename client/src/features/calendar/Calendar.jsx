    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div
            className={`backdrop-blur-xl rounded-3xl border shadow-2xl overflow-hidden ${
              darkMode
      ...
      {showDateEvents && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div
            className={`bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-8 max-w-lg w-full relative`}
          >
            <button
              ...
              <ul className="space-y-4">
                {eventsForSelectedDate.map((event) => (
                  <li
                    ...
                    className="p-4 rounded-xl border dark:border-slate-600 border-gray-200 bg-gray-50 dark:bg-slate-700"
                  >
      ...
      <style jsx global>{`
        ...
        .calendar-container .fc-button {
          ...
          border: 1px solid
            ${darkMode ? "rgba(51, 65, 85, 0.3)" : "rgba(229, 231, 235, 0.5)"} !important;
          color: ${darkMode
            ? "rgb(156, 163, 175)"
