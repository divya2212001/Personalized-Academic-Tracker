...
import LeftDateColoumn from "../components/layout/LeftDateColoumn.jsx";
import MainTimeline from "../features/dashboard/MainTimeline.jsx";
...
function HomePageLayout({ darkMode, setDarkMode }) {
  ...
  return (
    <div
      className={`flex min-h-screen w-full transition-colors duration-300 ${bgClass}`}
    >
      {/* Sidebar */}
      <Sidebar
        darkMode={darkMode}
        ...
        <main className="flex flex-row w-full h-[calc(100vh-64px)]">
          ...
          <div className="flex-1 overflow-auto">
            <Routes>
              ...
              <Route
                path="/tracker"
                element={<Tracker darkMode={darkMode} />}
              />
              <Route
                path="/settings"
